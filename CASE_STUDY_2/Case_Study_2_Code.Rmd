...
#Sabrina WD
offline_f_path = "/Users/sabri/Documents/Masters/QTW_7333/Case_Study_2/offline.final.trace.txt"
online_f_path = "/Users/sabri/Documents/Masters/QTW_7333/Case_Study_2/online.final.trace.txt"
```
...
```{r}
#creating visualizations and descriptive statistics of the data
library(ggplot2)
ggplot()+geom_point(data = offlineFold, mapping = aes(x=posX, y=posY))+geom_point(data = onlineFold, mapping = aes(x=posX, y=posY, color="Online"))
```

```{r}
ggplot()+geom_point(data = offline, mapping = aes(x=posX, y=posY))+geom_point(data = online, mapping = aes(x=posX, y=posY), color='blue')
```
