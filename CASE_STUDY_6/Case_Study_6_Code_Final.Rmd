...
```{r}
#Proportion table for spam vs ham emails in the dataset
...
```{r}
xgbFinal = xgb.load("C:/Users/seans/Desktop/GitHub/DS7333-master (2)/DS7333-master/CASE_STUDY_6/xgbFinal")
```
