...
Evaluating the out of state participation next, to address accommodations needed by the race sponsor.  Note, because the race is in DC, we also excluded participants in VA and MD.
```{r}
